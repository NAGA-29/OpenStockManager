    ...
    @section('main_contents')
        <div>
            @include('component.summary_cards', ['title' => __('その他')])
            ...
            <div>
                <div class="row device-toolbar">
                    ...
                    @include('component.search_form', ['hiddenType' => 'OTH'])
                </div>
                <div class="row device-pagination">
                    <div class="col-md-12 col-xl-6">
                        {{ $other_info_collection->links() }}
                    </div>
                </div>
            </div>
            <div class=" bg-white rounded shadow table-responsive text-nowrap">
                <table class="table table-hover">
                    ...
                    <tbody>
                        @foreach ($other_info_collection as $device_info)
