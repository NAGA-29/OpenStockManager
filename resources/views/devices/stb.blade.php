...
@section('main_contents')
    <div>
        @include('component.summary_cards', ['title' => __('STB')])
        ...
        <div>
            <div class="row device-toolbar">
                ...
                @include('component.search_form', ['hiddenType' => 'STB'])
            </div>
        ...
        <div class=" bg-white rounded shadow table-responsive text-nowrap">
            <table class="table table-hover">
                ...
                <tbody>
                    @foreach ($stb_info_collection as $device_info)
                        ...
                        <td><a href="{{ route('device.individual', ['device_id' => $device_info->device_id]) }}">
