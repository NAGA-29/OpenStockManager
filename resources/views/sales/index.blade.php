    ...
    <div class="bg-white rounded shadow table-responsive text-nowrap">
        ...
        <div class="tab-content">
            <div id="contents1" class="tab-pane active">
                @include('sales.components.cart')
            </div>
            <div id="contents2" class="tab-pane">
                @include('sales.components.file')
            </div>
        </div>
    </div>

    <!-- Lending Modal -->
    <div class="modal fade" id="ClientSearchModal" tabindex="-1" role="dialog" aria-labelledby="clientSearchSalesModalTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <!--  貸出対応判定 -->
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="clientSearchSalesModalTitle">販売先のクライアント検索</h5>
